...
static void load_weights_async(Layer tile, Layer body, Layer layer, TileIndex index) {
  dma_transfer_async((DmaTransferConf) {
    ...
    .length_1d_copy = (int) tile.weights.output_channel * 2 * 1*128 / 8,
    .hwc_to_chw = 0,
    .stride_2d = 32,
    .stride_1d = 1,
    .dir = 1
...
void __attribute__ ((noinline)) BNReluConvolution1(void *args) {
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 60800 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 60808, l1_buffer + 60808 + 15200 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 76016, l1_buffer + 76016 + 1280 },
    .index = 0
  };
