...
static void kernel(Layer tile, void * im2col, void * pwt_buffer) {
    pulp_nn_linear_u2_i32_i2(
      tile.addr.input,
      tile.addr.bias,
      tile.addr.output,
      tile.addr.weights,
      tile.input.channel, tile.output.channel
      );
}
...
void __attribute__ ((noinline)) FullyConnected6(void *args) {
  //////////////////////////////////////////////////////////////////////////
  ...
  const Layer layer = {
    .addr = {
      ...
      .bias = layer_args->L2_weights + 464,
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 232 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 240, l1_buffer + 240 + 8 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 256, l1_buffer + 256 + 464 },
    .index = 0
  };
  ...
  for(int iter=0; iter < total_tiles; iter++) {
    Address addr = {
      ...
      .bias = l1_buffer + 744 + index.output_channel * 8,
