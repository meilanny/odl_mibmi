...
static void load_weights_async(Layer tile, Layer body, Layer layer, TileIndex index) {
  dma_transfer_async((DmaTransferConf) {
    .ext = dory_get_tile_3d(layer.addr.weights,
                            ...
                            body.weights.output_channel, 8*1, body.weights.input_channel,
                            8*1, 4,
                            0, 0, 0,
                            0, 0, 0,
                            2),
...
void __attribute__ ((noinline)) BNReluConvolution0(void *args) {
  //////////////////////////////////////////////////////////////////////////
  ...
  const Layer layer = {
    .addr = {
      ...
      .scale = layer_args->L2_weights + 256,
      .bias = layer_args->L2_weights + 384,
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 22720 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 45448, l1_buffer + 45448 + 22720 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 90896, l1_buffer + 90896 + 512 },
    .index = 0
  };
  ...
  for(int iter=0; iter < total_tiles; iter++) {
    Address addr = {
      ...
      .scale = double_buffer_get_addr(db_weights) + 256,
      .bias = double_buffer_get_addr(db_weights) + 256 + 128,
