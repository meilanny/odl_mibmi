...
void execute_layer_fork(void *args) {
  ...
  layer_args->L1_buffer = pi_cl_l1_malloc(NULL, 72700);
#else
  layer_args->L1_buffer = pmsis_l1_malloc(72700);
#endif
...
#ifdef TARGET_CHIP_FAMILY_GAP9
  pi_cl_l1_free(NULL, layer_args->L1_buffer, 72700);
#else
  pmsis_l1_malloc_free(layer_args->L1_buffer, 72700);
#endif
}
